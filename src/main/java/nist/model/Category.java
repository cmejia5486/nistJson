...
public class Category {
    ...
    public String toString() {
        return "Category{" + "ID=" + ID + ", entries=" + entries + ", summary=" + summary + ", number_of_vulnerabilities=" + number_of_vulnerabilities + ", average_score=" + average_score + ", presence=" + presence + ", impact=" + impact + ", number_of_criticality_for_health_vulnerabilities=" + number_of_criticality_for_health_vulnerabilities + '}';
    }
