...
public class EntryController {
    ...
    private ArrayList<String> getVulnerableSoftware1(String vulne, JsonObject obj) {
        ...
        if (obj.get("configurations").getAsJsonObject() != null) {
            ...
            if (tmp != null && tmp.size() > 0) {
                for (JsonElement jsonElement : tmp) {
                    if (jsonElement.getAsJsonObject().get("cpe_match") != null && !jsonElement.getAsJsonObject().get("cpe_match").toString().equals("[]")) {
